...
<head>
    ...
    <link rel="stylesheet" href="assets/css/indigency.css">
</head>
...
<body>
    <section class="header">
        ...
        <nav class="navbar">
            <ul>
                <a href="indigency.php" class="active">Indigency</a>
        ...
        <div class="wrapper">
            ...
            <form action="" method="POST" autocomplete="on" enctype="multipart/form-data">
                <div class="fields">
                    ...
                    <div class="input-field">
                        <label for="rReason1">Unable to support expenses for:<font color=red> * </font color></label>
                        <input type="text" id="rReason1" name="rReason1" placeholder="Enter Reason" required>
                    </div>

                    <div class="input-field">
                        <label for="rReason2">Granted to requester for use in:<font color=red> * </font color></label>
                        <input type="text" id="rReason2" name="rReason2" placeholder="Enter Reason" required>
                    </div>
